...
<template>
    ...
    <section id="home" class="relative min-h-[calc(100vh-85px)] overflow-x-clip bg-slate-100 dark:bg-[#0B1120]">
        ...
        <div class="container mx-auto px-3 flex flex-col justify-center items-center min-h-[calc(100vh-85px)] max-w-6xl 2xl:max-w-7xl">
            ...
            >
                <a href="https://github.com/kadirn7" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/github.png" alt="Kadir's Github" />
                ...
                <a href="https://www.linkedin.com/in/kadir-pasaoglu/" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/linkedin.png" alt="Kadir's Linkedin" />
            ...
            >
                <LinkButton link="#about" class="text-sm md:text-xl px-5 py-3 md:px-7 md:py-4"> Hakkımda </LinkButton>
